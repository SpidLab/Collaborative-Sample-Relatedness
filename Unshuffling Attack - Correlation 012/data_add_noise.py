...
user_id = caseIDs + controlIDs

#add noise
for itr in range(5):
    for epsilon in range(40, 50, 10):
        eps = epsilon / 10.0
        print ('------', eps)
        ...
        print (p, q)
        data = pd.read_csv("Data/Eye_color/original_3000_SNPs_mixture_chrm15.csv", sep = ",", index_col=0)
        ...
        output_dir = Path('Data/Eye_color/Noisy_data/run_' + str(itr))
