...
def compute_accuracy():
    ...
    # attacker_df = pd.read_csv("Data/Eye_color/original_3000_SNPs_mixture_chrm15.csv", sep=',', index_col=0)
    ...
    n = 20 # select only the top X SNPs, because of performance issues
    ...
    for SNP1 in SNPlist:
        for SNP2 in SNPlist:
            MAF_difference[(SNP1, SNP2)] = abs(original_MAF[SNP1] - attacker_MAF[SNP2])
    ...
    # for SNP_low_MAF in sorted_MAF_diff.keys():
    #     print(sorted_MAF_diff[SNP_low_MAF])
